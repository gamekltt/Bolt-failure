...
path_fatigue = os.path.abspath('.')+"/src/"
path_overload =  os.path.abspath('.')+"/src/"
path_corrosion =  os.path.abspath('.')+"/src/Corrosion.jpg"
...
class BoltFailure(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.operator(Fail_random_m3_noBreak.bl_idname,
                        text='Random_M3_noBreak')
        layout.operator(Fail_random_m6_noBreak.bl_idname,
                        text='Random_M6_noBreak')
...
class Break(Operator):
    ...
    def bf_fatigue_m3(self):
        ...
        bpy.ops.object.duplicate_move(OBJECT_OT_duplicate={"linked": False, "mode": 'TRANSLATION'}, TRANSFORM_OT_translate={"value": (0, 0, 0), "orient_type": 'GLOBAL', "orient_matrix": ((0, 0, 0), (0, 0, 0), (0, 0, 0)), "orient_matrix_type": 'GLOBAL', "constraint_axis": (False, False, False), "mirror": False, "use_proportional_edit": False, "proportional_edit_falloff": 'SMOOTH', "proportional_size": 1,
        ...
        bpy.ops.mesh.bisect(plane_co=(x-0.479469, y-3.81415, z+4.26963+length-coe), plane_no=(0.0101329, -
                            0.0831298, 0.996487), use_fill=False, clear_outer=True, xstart=623, xend=922, ystart=401, yend=429)
        bpy.ops.object.mode_set(mode='OBJECT')
        bpy.context.view_layer.objects.active = obj_above
        bpy.ops.object.mode_set(mode='EDIT')
        bpy.ops.mesh.select_all(action='SELECT')
        bpy.ops.mesh.bisect(plane_co=(x-0.479469, y-3.81415, z+4.26963+length-coe), plane_no=(0.0101329, -
                            0.0831298, 0.996487), use_fill=False, clear_inner=True, xstart=623, xend=922, ystart=401, yend=429)
        bpy.ops.object.mode_set(mode='OBJECT')
    ...
    def bf_Hydrogen_m3(self):
        ...
        bpy.ops.object.mode_set(mode='EDIT')
        bpy.ops.mesh.select_all(action='SELECT')
        bpy.ops.mesh.bisect(plane_co=(x-0.479469, y-3.81415, z+4.26963+length-6), plane_no=(0.0101329, -
                            0.0831298, 0.996487), use_fill=True, clear_outer=True, xstart=623, xend=922, ystart=401, yend=429)
        bpy.ops.object.mode_set(mode='OBJECT')
        bpy.context.view_layer.objects.active = obj_above
        bpy.ops.object.mode_set(mode='EDIT')
        bpy.ops.mesh.select_all(action='SELECT')
        bpy.ops.mesh.bisect(plane_co=(x-0.479469, y-3.81415, z+4.26963+length-6), plane_no=(0.0101329, -
                            0.0831298, 0.996487), use_fill=True, clear_inner=True, xstart=623, xend=922, ystart=401, yend=429)
        bpy.ops.object.mode_set(mode='OBJECT')
    ...
    def bf_Hydrogen_m6(self):
        ...
        bpy.ops.object.mode_set(mode='EDIT')
        bpy.ops.mesh.select_all(action='SELECT')
        bpy.ops.mesh.bisect(plane_co=(x-0.479469, y-3.81415, z+4.26963+length-8), plane_no=(0.0101329, -
                            0.0831298, 0.996487), use_fill=True, clear_outer=True, xstart=623, xend=922, ystart=401, yend=429)
        bpy.ops.object.mode_set(mode='OBJECT')
        bpy.context.view_layer.objects.active = obj_above
        bpy.ops.object.mode_set(mode='EDIT')
...
class Corrosion(Operator):
    ...
    def rustbin(self):
        ...
        principled2_node = BoltCorrosion.node_tree.nodes.new(
        ...
        ColorRamp1_node = BoltCorrosion.node_tree.nodes.new(
            'ShaderNodeValToRGB')
        ...
        Voronoi_node = BoltCorrosion.node_tree.nodes.new(
            'ShaderNodeTexVoronoi')
        Voronoi_node.location = (-700, 0)
        Voronoi_node.inputs[2].default_value = 2
        ColorRamp2_node = BoltCorrosion.node_tree.nodes.new(
            'ShaderNodeValToRGB')
...
class Headfail(bpy.types.Operator):
    ...
    def hf_Torx_m3(self):
        ...
        bpy.ops.mesh.primitive_cone_add(
            radius1=1, radius2=r, depth=1.5, enter_editmode=False, align='WORLD', location=(0, 0, 0), scale=(1, 1, 1))
        ...
        bpy.ops.mesh.primitive_cylinder_add(
            radius=1.5, depth=1, enter_editmode=False, align='WORLD', location=(0, 0, 0), scale=(1, 1, 1))
    ...
    def hf_Phillips_m3(self):
        ...
        z = obj_bolt.location[2]
        bpy.ops.mesh.primitive_cone_add(
            radius1=0.3, radius2=r, depth=2, enter_editmode=False, align='WORLD', location=(0, 0, 0), scale=(1, 1, 1))
    ...
    def hf_Allen_m6(self):
        ...
        z = obj_bolt.location[2]
        bpy.ops.mesh.primitive_cone_add(
            radius1=2, radius2=r, depth=3, enter_editmode=False, align='WORLD', location=(0, 0, 0), scale=(1, 1, 1))
        obj_cone = bpy.context.active_object
        obj_cone.location[0] = x
        obj_cone.location[1] = y
        ...
        bpy.ops.object.booltool_auto_difference()
        bpy.ops.mesh.primitive_cylinder_add(
            radius=3, depth=2, enter_editmode=False, align='WORLD', location=(0, 0, 0), scale=(1, 1, 1))
        obj_cyl = bpy.context.active_object
        obj_cyl.location[0] = x
        obj_cyl.location[1] = y
    ...
    def hf_Torx_m6(self):
        ...
        bpy.ops.object.booltool_auto_difference()
        bpy.ops.mesh.primitive_cylinder_add(
            radius=2.9, depth=2, enter_editmode=False, align='WORLD', location=(0, 0, 0), scale=(1, 1, 1))
        obj_cyl = bpy.context.active_object
        obj_cyl.location[0] = x
        obj_cyl.location[1] = y
        obj_cyl.location[2] = z+20.001+high-20
    ...
    def hf_Phillips_m6(self):
        ...
        z = obj_bolt.location[2]
        bpy.ops.mesh.primitive_cone_add(
            radius1=0.6, radius2=r, depth=4, enter_editmode=False, align='WORLD', location=(0, 0, 0), scale=(1, 1, 1))
        obj = bpy.context.active_object
        obj.location[0] = x
        obj.location[1] = y
    ...
    def execute(self, context):
        ...
        if overload <= 4:
            ...
            for x in n:
                ...
                if x == 2:
                    bpy.ops.fail.head(
                        bf_Bit_Type='bf_Allen', Bolt_Type='M3', Shank_Length=20, Hf_radius=r_m3_allen)
                if x == 3:
                    pass
            ...
            for x in n:
                ...
                if x == 2:
                    bpy.ops.fail.head(
                        bf_Bit_Type='bf_Torx', Bolt_Type='M3', Shank_Length=20, Hf_radius=r_m3_torx)
                if x == 3:
                    pass
            ...
            for x in n:
                ...
                if x == 2:
                    bpy.ops.fail.head(
                        bf_Bit_Type='bf_Phillips', Bolt_Type='M3', Shank_Length=20, Hf_radius=r_m3_phillips)
                if x == 3:
                    pass
        else:
            i = self.get_bolt()
            for x in n:
                ...
                if x == 3:
                    ...
                    if breaktype == 1:
                        bpy.ops.fail.bre(
                            bf_Break_Type='bf_Break_Fatigue', Bolt_Type='M3', Shank_Length=20)
                    if breaktype == 2:
                        bpy.ops.fail.bre(
                            bf_Break_Type='bf_Break_Hydrogen', Bolt_Type='M3', Shank_Length=20)
                if x == 2:
                    if i == 1:
                        bpy.ops.fail.head(
                            bf_Bit_Type='bf_Allen', Bolt_Type='M3', Shank_Length=20, Hf_radius=r_m3_allen)
...
class Fail_random_m6(bpy.types.Operator):
    ...
    def get_bolt(self):
        i = random.randint(1, 3)
        if i == 1:
            bpy.ops.mesh.bolt_add(align='WORLD', location=(0, 0, 0), rotation=(0, 0, 0), change=False, bf_Model_Type='bf_Model_Bolt', bf_Head_Type='bf_Head_Hex', bf_Bit_Type='bf_Bit_Allen', bf_Nut_Type='bf_Nut_Hex', bf_Shank_Length=0, bf_Shank_Dia=6, bf_Phillips_Bit_Depth=2.44961, bf_Allen_Bit_Depth=3, bf_Allen_Bit_Flat_Distance=5, bf_Torx_Size_Type='bf_Torx_T30', bf_Torx_Bit_Depth=3, bf_Hex_Head_Height=4, bf_Hex_Head_Flat_Distance=10, bf_12_Point_Head_Height=6,
                                  bf_12_Point_Head_Flat_Distance=6, bf_12_Point_Head_Flange_Dia=10.22, bf_CounterSink_Head_Dia=12.6, bf_Cap_Head_Height=6, bf_Cap_Head_Dia=10, bf_Dome_Head_Dia=12, bf_Pan_Head_Dia=12, bf_Philips_Bit_Dia=3.9, bf_Thread_Length=20, bf_Major_Dia=6, bf_Pitch=0.75, bf_Minor_Dia=5.1881, bf_Crest_Percent=10, bf_Root_Percent=10, bf_Div_Count=36, bf_Hex_Nut_Height=5, bf_Hex_Nut_Flat_Distance=10, bf_12_Point_Nut_Height=6, bf_12_Point_Nut_Flat_Distance=6, bf_12_Point_Nut_Flange_Dia=10.22)
        if i == 2:
            bpy.ops.mesh.bolt_add(align='WORLD', location=(0, 0, 0), rotation=(0, 0, 0), change=False, bf_Model_Type='bf_Model_Bolt', bf_Head_Type='bf_Head_Hex', bf_Bit_Type='bf_Bit_Torx', bf_Nut_Type='bf_Nut_Hex', bf_Shank_Length=0, bf_Shank_Dia=6, bf_Phillips_Bit_Depth=2.44961, bf_Allen_Bit_Depth=3, bf_Allen_Bit_Flat_Distance=5, bf_Torx_Size_Type='bf_Torx_T30', bf_Torx_Bit_Depth=3, bf_Hex_Head_Height=4, bf_Hex_Head_Flat_Distance=10, bf_12_Point_Head_Height=6,
                                  bf_12_Point_Head_Flat_Distance=6, bf_12_Point_Head_Flange_Dia=10.22, bf_CounterSink_Head_Dia=12.6, bf_Cap_Head_Height=6, bf_Cap_Head_Dia=10, bf_Dome_Head_Dia=12, bf_Pan_Head_Dia=12, bf_Philips_Bit_Dia=3.9, bf_Thread_Length=20, bf_Major_Dia=6, bf_Pitch=0.75, bf_Minor_Dia=5.1881, bf_Crest_Percent=10, bf_Root_Percent=10, bf_Div_Count=36, bf_Hex_Nut_Height=5, bf_Hex_Nut_Flat_Distance=10, bf_12_Point_Nut_Height=6, bf_12_Point_Nut_Flat_Distance=6, bf_12_Point_Nut_Flange_Dia=10.22)
        if i == 3:
    ...
    def execute(self, context):
        ...
        if overload <= 4:
            ...
            for x in n:
                ...
                if x == 2:
                    bpy.ops.fail.head(
                        bf_Bit_Type='bf_Allen', Bolt_Type='M6', Shank_Length=20, Hf_radius=r_m6_allen)
                if x == 3:
                    pass
        elif overload > 4 and overload <= 8:
            bpy.ops.wm.append(filepath="overload.blender",
            ...
            for x in n:
                ...
                if x == 2:
                    bpy.ops.fail.head(
                        bf_Bit_Type='bf_Torx', Bolt_Type='M6', Shank_Length=20, Hf_radius=r_m6_torx)
                if x == 3:
                    pass
        elif overload > 8 and overload <= 12:
            bpy.ops.wm.append(filepath="overload.blender",
            ...
            for x in n:
                ...
                if x == 2:
                    bpy.ops.fail.head(
                        bf_Bit_Type='bf_Phillips', Bolt_Type='M6', Shank_Length=20, Hf_radius=r_m6_phillips)
                if x == 3:
                    pass
        else:
            i = self.get_bolt()
            for x in n:
                ...
                if x == 3:
                    ...
                    if breaktype == 1:
                        bpy.ops.fail.bre(
                            bf_Break_Type='bf_Break_Fatigue', Bolt_Type='M6', Shank_Length=20)
                    if breaktype == 2:
                        bpy.ops.fail.bre(
                            bf_Break_Type='bf_Break_Hydrogen', Bolt_Type='M6', Shank_Length=20)
                if x == 2:
                    if i == 1:
                        bpy.ops.fail.head(
                            bf_Bit_Type='bf_Allen', Bolt_Type='M6', Shank_Length=20, Hf_radius=r_m6_allen)
